...
<MinimalistBox title="כוחו של ההורה במערכת היחסים" description="התפקיד ההורי הוא תפקיד משמעות בעולמו של התינוק. בתחילת הדרך מהות התפקיד שלנו הוא לעזור לתינוק להסתגל למציאות החדשה מחוץ לרחם ולייצר חוויות רחמיות חיוביות, בהמשך המחוייבות ההורית היא לעודד את ההתפתחות ולהבין את המשמעות הגדולה שניתנה בידי ההורה להיות עבור התינוק סביבה התפתחותית מיטבית תוך עידוד התקשרות בטוחה המהווה בסיס לביטחון ריגשי ולתחושת מסוגלות אישית שמתעצבת בתינוק לאורך הזמן."/>
</div>
