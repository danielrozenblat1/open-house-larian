...
<Why title="קואורדינציה ותנועה" description="בתהליכי הלמידה שלי נלמד איך להוביל לתנועות פאסיביות שמתבצעות באופן יזום ומכוון על ידי ההורה, מה שמוביל לשיפור התנועות ושליטה עליהן בהמשך . התינוק לומד להרגיש איך חלקי הגוף שלו נעים בתגובה ללחץ ולכוונה." icon={confident}/>
  ...
  <div className={styles.row}>
<Why title="מודעות הגוף" description="במגע עדין ועמוק ובתנועה ממוקדת של חלקי הגוף, נעודד את מערכת חישה עמוקה על מנת לעזור לתינוק להבין את הקשרים בין חלקי הגוף השונים. בעזרת העיסוי, התינוק מתחיל לזהות את חלקי גופו ואת מקומם ביחס לעצמם, ביחס לעצמו וביחס למרחב." icon={brain}/>
